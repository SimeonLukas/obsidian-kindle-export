    ...
    return __async(this, null, function* () {
      ...
      this.addCommand({
        ...
        callback: () => __async(this, null, function* () {
          ...
          let data = yield this.app.vault.adapter.read(dokument);
          ...
          if (dateiname != null) {
            ...
            for (let i2 = 0; i2 < files; i2++) {
              ...
              if (file.name == dateiname[1] && file.extension != "md") {
                let data = yield this.app.vault.adapter.readBinary(file.path);
              ...
              if (file.name == anker[0] + ".md" || file.name == dateiname[1] + ".md") {
                let data = yield this.app.vault.adapter.read(file.path);
