...
var KindleSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Author").setDesc("Default author for new documents").addText((text2) => text2.setPlaceholder("Obsidian").setValue(this.plugin.settings.author).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.author = value;
      yield this.plugin.saveSettings();
      console.log(this.plugin.settings);
    })));
    new import_obsidian.Setting(containerEl).setName("Email").setDesc("Approved Email for your Kindle").addText((text2) => text2.setPlaceholder("you@obsidian.md").setValue(this.plugin.settings.sendmail).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.sendmail = value;
      yield this.plugin.saveSettings();
      console.log(this.plugin.settings);
    })));
    new import_obsidian.Setting(containerEl).setName("Kindle Email").setDesc("Your Kindle Email").addText((text2) => text2.setPlaceholder("you@kindle.com").setValue(this.plugin.settings.kindlemail).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.kindlemail = value;
      yield this.plugin.saveSettings();
      console.log(this.plugin.settings);
    })));
    new import_obsidian.Setting(containerEl).setName("SMTP Host").setDesc("Your SMTP Host (e.g. smtp.gmail.com)").addText((text2) => text2.setPlaceholder("smtp.obsidian.md").setValue(this.plugin.settings.smtphost).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.smtphost = value;
      yield this.plugin.saveSettings();
      console.log(this.plugin.settings);
    })));
    new import_obsidian.Setting(containerEl).setName("SMTP Port").setDesc("Your SMTP Port (e.g. 587)").addText((text2) => text2.setPlaceholder("465").setValue(this.plugin.settings.port).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.port = value;
      yield this.plugin.saveSettings();
      console.log(this.plugin.settings);
    })));
    new import_obsidian.Setting(containerEl).setName("SMTP User").setDesc("Username for your SMTP Server e.g. your Mailadress").addText((text2) => text2.setPlaceholder("you@obsidian.md").setValue(this.plugin.settings.user).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.user = value;
      yield this.plugin.saveSettings();
      console.log(this.plugin.settings);
    })));
    new import_obsidian.Setting(containerEl).setName("SMTP Password").setDesc("Your SMTP Password").addText((text2) => text2.setPlaceholder("********").setValue(this.plugin.settings.pass).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.pass = value;
      yield this.plugin.saveSettings();
      console.log(this.plugin.settings);
    })));
    new import_obsidian.Setting(containerEl).setName("Backend").setDesc("Your Backendadress (e.g. https://staneks.de/apps/md2mobi/) can be used for free or host your own Backend.").addText((text2) => text2.setPlaceholder("https://ob2ki.com").setValue(this.plugin.settings.backend).onChange((value) => __async(this, null, function* () {
    ...
    return __async(this, null, function* () {
      ...
      this.addCommand({
        ...
        callback: () => __async(this, null, function* () {
          ...
          if (dokument == null) {
            new import_obsidian2.Notice("\u274C No active file. Please open a file first");
            return;
          }
          ...
          fetch(url, {
            ...
            new import_obsidian2.Notice("\u274C Internet Connection error or Server is offline");
          });
        })
      });
    });
  ...
  GetEbook(lines, Inhalt, imagelist, imagename, links) {
    return __async(this, null, function* () {
      for (let i = 0; i < lines.length; i++) {
        let text2 = lines[i];
        if (text2.contains("![[") && text2.contains("]]") || text2.contains("![") && text2.contains(")") && text2.contains("http://") && text2.contains("https://")) {
          ...
          if (file.extension == "md") {
            ...
            text2 = import_buffer.Buffer.from(data).toString("utf8");
            if (text2.startsWith("---")) {
              let start = text2.indexOf("---");
              let end = text2.indexOf("---", start + 3);
              text2 = text2.substring(end + 3);
            }
            ...
            if (anker != void 0) {
              if (anker.contains("^")) {
                console.log(anker);
                let ankercaret = text2.indexOf(anker);
                text2 = text2.substring(0, ankercaret);
                text2 = text2.substring(text2.lastIndexOf("\n"));
                heading = "";
              } else {
                let pos = text2.indexOf(anker);
                if (pos == -1) {
                  text2 = text2.substring(pos);
                } else {
                  text2 = text2.substring(pos + anker.length);
                }
                let pos2 = text2.indexOf("\n#", 30);
                if (pos2 == -1) {
                } else {
                  text2 = text2.substring(0, pos2);
                }
              }
            }
            text2 = heading + text2;
          ...
          if (text2.contains("![") && text2.contains(")") && text2.contains("http://") || text2.contains("![") && text2.contains(")") && text2.contains("https://")) {
            console.log("EXTERN");
            let ImageLink = text2.substring(text2.indexOf("(") + 1, text2.indexOf(")"));
